...
altair_crud_table = {
    init: function () {
        ...
        $('#category_table').jtable({
            ...
            actions: {
                listAction: '/api/Category/Admin?action=list',
                createAction: '/api/Category/Admin?action=create',
                updateAction: '/api/Category/Admin?action=update',
                deleteAction: '/api/Category/Admin?action=delete'
            },
            fields: {
                Id: {
                    key: true,
                ...
                Photo: {
                    ...
                    display: function (data) {
                        return '<img style="width:100px;height:100px;" src=' + data.record.Photo + '/>'
                    }
