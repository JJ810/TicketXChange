...
altair_crud_table = {
    init: function () {
        ...
        $('#payment_table').jtable({
            ...
            actions: {
                listAction: '/api/Payment/Admin?action=list',
                createAction: '/api/Payment/Admin?action=create',
                updateAction: '/api/Payment/Admin?action=update',
                deleteAction: '/api/Payment/Admin?action=delete'
            },
            fields: {
                Id: {
                    key: true,
                ...
                TicketId: {
                    title: 'Name',
                    width: '17%',
                    options: '/api/TicketName/GetJson'
                },
                Quantity: {
                    title: 'Quantity',
                    width: '7%'
