...
altair_crud_table = {
    init: function () {
        ...
        $('#sell_table').jtable({
            ...
            actions: {
                listAction: '/api/Sell/Admin?action=list',
                createAction: '/api/Sell/Admin?action=create',
                updateAction: '/api/Sell/Admin?action=update',
                deleteAction: '/api/Sell/Admin?action=delete'
            },
            fields: {
                Id: {
                    key: true,
